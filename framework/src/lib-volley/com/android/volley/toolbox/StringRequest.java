...
public class StringRequest extends Request<String> {
	 ...
	 */
	public StringRequest(int method, String url, ResponseListener<String> listener) {
	 ...
	 *            Error listener, or null to ignore errors
	 */
	public StringRequest(String url, ResponseListener<String> listener, ErrorListener errorListener) {
