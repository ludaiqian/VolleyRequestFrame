...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	public final static String FORM_FILE_CONTENT_TYPE = "multipart/form-data" + "; boundary=" + BOUNDARY;
	public final static String FORM_FILE_END_LINE = "--" + BOUNDARY + "--\r\n";
	...
	/** An opaque token `ging this request; used for bulk cancellation. */
	private Object mTag;

	private ResponseListener<T> mListener;

	private ProgressListener mFormFileUploadingListener;
	 ...
	 * throw {@link null} as authentication may be required to
	 ...
	 * a simple GET should be used. Can throw {@link null} as
	...
	public String getPostFormFileContentType() {
		return FORM_FILE_CONTENT_TYPE;
	}

	public String getPostFormFileEndline() {
		return FORM_FILE_END_LINE;
	}
	 ...
	 * cause delivery of a {@link null} error.
	 */
	 ...
	 */
	protected HttpError parseNetworkError(HttpError volleyError) {
		return volleyError;
	}
	...
	public static class FormParam {
		...
		public String getParamDisposition() {
			...
			buffer.append("\r\n");
			buffer.append("Content-Disposition: form-data; name=\"" + getName() + "\"\r\n\r\n");
	...
	public static class FormFile {
		...
		public String getFileName() {
			return fileName!=null?fileName:"VolleyFile";
		}
		...
		public String getFileDisposition() {
			...
			buffer.append(BOUNDARY);
			buffer.append("\r\n");
			buffer.append("Content-Disposition: form-data;name=\"" + getName() + "\";filename=\"" + getFileName() + "\"\r\n");
		...
		@Override
		public String toString() {
			return "FormFile [data=" + Arrays.toString(data) + ", fileName=" + fileName + ", name=" + name
	...
	public interface ProgressListener {
		 ...
		 */
		void onProgress(long totalSize,long transferredBytes);
	}


	public ProgressListener getFormFileUploadingListener() {
		return mFormFileUploadingListener;
	}

	public void setFormFileUploadingListener(ProgressListener formFileUploadingListener) {
		mFormFileUploadingListener = formFileUploadingListener;
	}

	public void postFormFileUploadingProgress(long total, long current) {
		if (mFormFileUploadingListener != null)
			mFormFileUploadingListener.onProgress(total, current);
	}

	public boolean hasPostFormFiles() {
		return getPostFormFiles() != null && getPostFormFiles().size() > 0;
	}
